            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">info@melexis.tech</p>
                    <p className="text-gray-400">support@melexis.tech</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-800 hover:bg-indigo-600 text-white p-3 rounded-full transition-colors">
          ...
          <div className="bg-gray-900 rounded-xl overflow-hidden">
            <div className="aspect-video w-full">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.1051089686086!2d-122.39981368468226!3d37.78226797975813!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80858062c2d7bc13%3A0x6c14d69a3f8b76a4!2sMarket%20St%2C%20San%20Francisco%2C%20CA%2C%20USA!5e0!3m2!1sen!2s!4v1579736222881!5m2!1sen!2s"
                allowFullScreen
              ></iframe>
            </div>
          </div>
