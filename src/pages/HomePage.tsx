            ...
            <div className="animate-fade-in">
              ...
              <div className="flex items-center mt-10">
                <div className="flex -space-x-3">
                  <img src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Client" className="w-10 h-10 rounded-full border-2 border-gray-900" />
                  <img src="https://images.pexels.com/photos/3775534/pexels-photo-3775534.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Client" className="w-10 h-10 rounded-full border-2 border-gray-900" />
                  <img src="https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Client" className="w-10 h-10 rounded-full border-2 border-gray-900" />
                </div>
                <div className="ml-4">
